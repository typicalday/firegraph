...
| `core-library.md`     | `src/**/*.ts`                                                                                                                                                      | Capability-gated backends, Firestore edition internals, query planning, traversal |
| `backends.md`         | `src/firestore-standard/**`, `src/firestore-enterprise/**`, `src/sqlite/**`, `src/cloudflare/**`, `src/internal/{backend,routing-backend,firestore-*,sqlite-*}.ts` | Capability matrix, routing invariant, per-edition notes                           |
...
| `cloudflare.md`       | `src/cloudflare/**`, `tests/integration/cloudflare-*`, `tests/__shims__/cloudflare-*`                                                                              | DO backend, `cloudflare:workers` virtual module, workers-types perf footgun       |
